...
- **Vins au complet, le reste en accordéon (20 sept. 2026)** : la section **Vins** s'affiche entière ; les cinq sections d'« Accord selon… » sont **repliées** (titre `.emp-meuble-pliable` + chevron, corps dans un `.menu-liste`), **une seule ouverte à la fois** (`basculerSectionRechercheV2`). La section ouverte est retenue (`RECHERCHE_V2_SECTION_OUVERTE`) pendant qu'on continue de taper, et remise à zéro à l'ouverture de la recherche. S'il n'y a **aucun vin**, la première section s'ouvre d'elle-même.
