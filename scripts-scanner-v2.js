...
function afficherPromoV2() {
  ...
  div.innerHTML = liste.map(function(p) {
    ...
    var bonis = (p.pointsBonis && imgBonis[p.pointsBonis]) ? '<br><img src="' + imgBonis[p.pointsBonis] + '" alt="+' + p.pointsBonis + ' pts" style="height:32px;">' : (p.pointsBonis ? '<br>+' + p.pointsBonis + ' pts' : '');
