...
- **Liste du meuble** (4 septembre 2026, type `listemeuble` de `afficherListeEmpV2`) : tout le contenu du meuble choisi en **sections par cépage dominant** (`cepageDominant`, ordre alphabétique, casse et accents ignorés ; les vins sans cépage forment une section « Sans cépage »), vins alphabétiques sous chaque section, carte `X btl` + emplacements. Clic → fiche (provenance 'empliste'), retour à la liste par `empListeV2Type`.
