...
### 🟢 Risques mineurs
7. **Pas de protection si CONFIG n'a pas chargé** : si on clique très vite au démarrage, certaines fonctions (`updateRangees`, etc.) peuvent planter.
8. **Champ "Racheter" vs "Aimé"** : nommage incohérent entre backend (`AIME`) et frontend (`Racheter`). Confus mais fonctionne.
